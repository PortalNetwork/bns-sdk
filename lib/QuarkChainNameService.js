...
var _registryService = require("./helper/qcns/registryService");

var _resolverService = require("./helper/qcns/resolverService");

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var QuarkChainNameService = function () {
  // Provider URL
  function QuarkChainNameService(restURL, networkId) {
