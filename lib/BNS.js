...
exports.NEO = exports.ICON = exports.Tomochain = exports.QuarkChain = exports.Wanchain = exports.EthereumClassic = exports.Ethereum = undefined;
...
var _NEONameService = require("./NEONameService");

var _NEONameService2 = _interopRequireDefault(_NEONameService);
...
var NEO = exports.NEO = function NEO(config) {
  _classCallCheck(this, NEO);
  ...
  this.NEONameService = new _NEONameService2.default(this.restURL, this.networkId);
};