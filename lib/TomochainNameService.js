...
var _registryService = require("./helper/tns/registryService");

var _resolverService = require("./helper/tns/resolverService");

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var TomochainNameService = function () {
  // Provider URL
  function TomochainNameService(restURL, networkId) {
    _classCallCheck(this, TomochainNameService);

    this.restURL = restURL;
    this.networkId = networkId;
  }

  _createClass(TomochainNameService, [{
    key: "getResolver",
  ...
  return TomochainNameService;
}();

exports.default = TomochainNameService;